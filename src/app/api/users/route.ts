  ...
  try {
    ...
    const DEFAULT_REAL_USERS: Record<string, UserData> = {
      "5787141744": {
        ...
        currentDayIndex: 1,
        currentWordInDay: 5,
        totalWordsLearned: 19,
        totalWordsLearnedRu: 19,
        totalWordsLearnedEn: 0,
    ...
    const userList = Object.values(parsedUsers).map((u) => {
      ...
      return {
        ...
        wordsLearned: (u.totalWordsLearnedRu ?? 0) + (u.totalWordsLearnedEn ?? 0) || (u.totalWordsLearned || 0),
        wordsLearnedRu: u.totalWordsLearnedRu ?? (isEnglish ? 0 : (u.totalWordsLearned || 0)),
        wordsLearnedEn: u.totalWordsLearnedEn ?? (isEnglish ? (u.totalWordsLearned || 0) : 0),
